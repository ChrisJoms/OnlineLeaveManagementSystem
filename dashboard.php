...
<body>
	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3" style="bottom: 38px">
					<a href="#" class="btn btn-danger btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#addDecModal"><i class="fa fa-times"></i> Declined Leaves</a>
				</div>
				<div class="col-md"></div>
			</div>
		</div>
	...
	<section id="post">
		<div class="container">
			<div class="row">
			<table id="datatableid" width="1200px" class="table table-bordered table-hover table-striped">
							<thead>
								<th>#</th>
								<th>Name</th>
								<th>Department</th>
